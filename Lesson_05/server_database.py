...
class ServerStorage:
    ...
    def __init__(self, path):
        # Создаём соединение с базой данных sqlite:///server_base.db3
        # echo=False - отключаем отображение лога всех создаваемых SQL-запросов
        # pool_recycle = 7200 - переустанавливаем соединение с базой через 2 часа (7200 секунд)
        print(path)
        self.database_engine = create_engine(f'sqlite:///{path}', echo=False, pool_recycle=7200,
                                             connect_args={'check_same_thread': False})

        # Подготовим "запрос" на создание таблиц внутри каталога MetaData
        ...
        # Создаём таблицу истории клиента
        ...
        # Создаём отображения между таблицами и классами
...
if __name__ == '__main__':
    # test_db = ServerStorage('server_base_test.db3')
    ...
    # print(test_db.users_list())
    test_db = ServerStorage('server_base_server_test.db3')
    test_db.user_login('User_1', '192.168.1.2', 8080)
    test_db.user_login('User_2', '192.168.1.3', 8081)
    test_db.user_login('User_3', '192.168.1.4', 8083)
    print('users_list', test_db.users_list())
    print('active_users_list', test_db.active_users_list())
    test_db.user_logout('User_2')
    print('login_history', test_db.login_history('User_2'))
    test_db.add_contact('User_1', 'User_2')
    test_db.add_contact('User_1', 'User_3')
    test_db.add_contact('User_2', 'User_3')
    print('get_contacts User_1', test_db.get_contacts('User_1'))
    test_db.del_contact('User_1', 'User_2')
    test_db.del_contact('User_1', 'User_3')
    test_db.del_contact('User_2', 'User_3')
    print('get_contacts User_2', test_db.get_contacts('User_2'))
    print('get_contacts User_1', test_db.get_contacts('User_1'))
    test_db.process_message('User_2', 'User_1')
