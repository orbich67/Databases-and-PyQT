...
class ClientDatabase:
    ...
    def __init__(self, name):
        ...
        self.database_engine = create_engine(f'sqlite:///client_database/client_{name}.db3',
                                             echo=False,
                                             pool_recycle=7200,
...
if __name__ == '__main__':
    test_db = ClientDatabase('base_client_test')
    ...
    print(test_db.get_history(to_who='User2'))
    print(test_db.get_history('User2'))
